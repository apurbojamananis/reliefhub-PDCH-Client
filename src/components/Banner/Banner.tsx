          ...
          <div className="grid grid-cols-2 h-full gap-5 relative">
            <div className=" col-span-1 overflow-hidden hidden lg:block">
              <div className="absolute bottom-0 left-0 ">
                <img src={mainHero} alt="" className=" size-9/12 2xl:size-full object-contain " />
              </div>
            </div>
            <div className="col-span-2 lg:col-span-1 text-white flex flex-col justify-center">
              ...
              <p className="mt-8 text-white w-full md:w-2/3 lg:w-full">
                Mobilizing Emergency Flood Response. As waters rise and communities face peril, it's
                imperative to unite swiftly in our response. Join us in providing critical aid,
                support, and solidarity to those affected. Together, we can stem the tide of
